  ...
  return (
    <div className="w-1/4 max-w-sm bg-slate-900 border-r border-slate-800 flex flex-col z-10">
      ...
      {sentRequests.length > 0 && (
        <div className="mx-4 mb-4 p-3 bg-slate-800 rounded-xl border border-slate-700 shadow-sm">
      ...
      <div className="p-4 border-b border-slate-800 bg-slate-900 relative">
        ...
        {searchResults.length > 0 && (
          <div className="absolute left-4 right-4 top-14 bg-slate-800 border border-slate-700 rounded-lg shadow-xl z-50 overflow-hidden">
              ...
              <div key={chatUsername} className="group flex items-center gap-0">
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] text-green-500/80 font-medium uppercase tracking-wider">
